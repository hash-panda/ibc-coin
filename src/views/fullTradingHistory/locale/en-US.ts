export default {
    ...
    'fullTradingHistory.filter.address': 'Account Address',
    'fullTradingHistory.filter.address.placeholder': 'Input Address',
    'fullTradingHistory.table.header.buySell': 'Buy/Sell',
    'fullTradingHistory.table.header.buySell.sell': 'Sell',
    'fullTradingHistory.table.header.buySell.buy': 'Buy',
